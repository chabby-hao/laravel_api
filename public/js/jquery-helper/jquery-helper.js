...
function myalert(msg) {
    ...
    var modal = $('<div id="myAlert" class="modal hide"> <div class="modal-header"> <button data-dismiss="modal" class="close" type="button">×</button> <h3>提示</h3> </div> <div class="modal-body"> <p>' + msg + '</p> </div> <div class="modal-footer"> <!--<a data-dismiss="modal" class="btn btn-primary" href="#">Confirm</a>--> <a data-dismiss="modal" class="btn alert2" href="#">OK</a> </div> </div> ');
