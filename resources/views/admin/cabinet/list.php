...
<!--                                    <th>操作</th>-->
                                ...
                                <?php foreach ($devices as $row) { ?>
                                    <tr class="gradeX">
                                        <td><?php echo ++$i; ?></td>
                                        <td><?php echo $row['cabinet_no'] ?></td>
                                        <td><a href="<?php echo URL::action('Admin\CabinetController@doorList',['id'=>$row->id]); ?>">查看</a></td>
                                        <?php if ($row['url']) { ?>
                                            <td><img width="100" height="100" src="<?php echo $row['url'] ?>" alt="未设置"></td>
                                        <?php } else { ?>
                                            <td>未生成</td>
                                        <?php } ?>
