    ...
    public static function getLocList($tencent = false)
    {
        $datas = [
            ...
            [
                'device_no' => '002100007',
                'value' => [//31.3238440000,121.4468100000
                    floatval(121.4505400000),
                    floatval(31.2126870000),
                ],
            ],
            [
                'device_no' => '002100008',
                'value' => [//31.3238440000,121.4468100000
                    floatval(121.4363060000),
                    floatval(31.4033030000),
                ],
            ],
            [
                'device_no' => '002100009',
                'value' => [//31.3238440000,121.4468100000
                    floatval(121.4476080000),
                    floatval(31.3213300000),
                ],
            ],
            [
                'device_no' => '002100010',
                'value' => [//31.3238440000,121.4468100000
                    floatval(121.4486100000),
                    floatval(31.3222520000),
                ],
            ],
